...
public class ThemisActionValidatorTest {
  ...
  public void validAction1Test()
    ...
    ThemisActionValidator.validate(
        Action.KubernetesChangeResourcesOfContainerWithinDeploymentAction, b.getParams());
  }
  ...
  public void invalidAction1Test() {
    ...
    Assertions.assertThrows(
        InvalidThemisActionException.class,
        () ->
            ThemisActionValidator.validate(
                Action.KubernetesChangeResourcesOfContainerWithinDeploymentAction, b.getParams()));
  }
  ...
  public void throwsNoThemisActionTemplateFoundExceptionTest() {
    ...
    Assertions.assertThrows(
        NoThemisActionTemplateFoundException.class,
        () -> {
          ThemisActionValidator.validate(Action.DEFAULT, b.getParams());
        });
  }
}
