...
public class RuleToDrlConverterTest {
    ...
    public void doesConvertedRuleCompileTest() {
        ...
        PolicyRule pRule = new PolicyRule(RuleAttribute.RESOURCE, RuleSubject.CPU, List.of(10), UnitType.PERCENT, RelationType.GT, Action.KubernetesChangeResourcesOfContainerWithinDeploymentAction, b);
