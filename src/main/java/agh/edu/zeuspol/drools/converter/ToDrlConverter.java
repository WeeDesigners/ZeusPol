...
public class ToDrlConverter {
    ...
    public ToDrlConverter(DrlImportsBuilder importsBuilder,  DrlNameBuilder drlRuleNameBuilder, DrlConditionBuilder drlConditionBuilder, List<DrlActionBuilder> drlActionBuilders) {
    ...
    public DrlStringFile convert() {
        ...
        String drlStringBuilder = this.packageName() +
                this.imports() +
                this.ruleBegin() +
                this.when() +
                this.conditions() +
