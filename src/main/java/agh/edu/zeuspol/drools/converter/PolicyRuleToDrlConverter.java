...
public class PolicyRuleToDrlConverter {
    ...
    public DrlStringFile convert(PolicyRule policyRule) {
        ...
        HttpClientThemisActionBuilder actionBuilder = new HttpClientThemisActionBuilder(policyRule.action);
        StatsDrlActionBuilder statsDrlActionBuilder = new StatsDrlActionBuilder(policyRule);
        SimpleDrlNameBuilder nameBuilder = new SimpleDrlNameBuilder(policyRule.id + "_" + policyRule.name);
        ...
        ToDrlConverter toDrlConverter = new ToDrlConverter(importsBuilder, nameBuilder, conditionBuilder, List.of(actionBuilder, statsDrlActionBuilder));
